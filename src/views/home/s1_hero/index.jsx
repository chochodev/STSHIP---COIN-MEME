    ...
    <div id='home' className='relative flex w-full'>
      <div className="flex flex-col py-[3.75rem] gap-[2.75rem] w-full">
        ...
        <div className="flex justify-center md:justify-end text-center items-center gap-[.5rem] md:gap-[.875rem] w-full pt-[4rem] ">
          ...
          <a href="https://t.me/StarShip_sol" target='_blank' rel='noopener noreferrer' className='h-[3rem]'>
          ...
          {/* <p className="text-[1.5rem] text-tertiary2 pb-2 ">|</p> */}
          <a href="https://www.dextools.io/widget-chart/en/solana/pe-light/AtNmDy6pkhQeeD72j5cRa7cy7MoFs759XRre3tA7uDpJ?theme=light&chartType=2&chartResolution=30&drawingToolbars=false" target='_blank' rel='noopener noreferrer' className='h-[3rem] overflow-hidden'>
          ...
          {/* <p className="text-[1.5rem] text-tertiary2 pb-2 ">|</p> */}
          <a href="https://birdeye.so/token/GHtLF7drbYXGTHX73uSxqPKkJUzDqcBNe2M9fzjJzr3j?chain=solana" target='_blank' rel='noopener noreferrer' className='h-[3rem] overflow-hidden'>
