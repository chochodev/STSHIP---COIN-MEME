    ...
    <div className='w-full flex flex-col gap-[3rem] py-[10rem] '>
      ...
      <div className="flex w-full justify-evenly flex-wrap">
        {items.map((item, index) => (
          <a href={item.link} target="_blank" key={index} className='flex justify-between text-center items-center w-[45%] max-w-[35rem] h-[3.5rem] px-[1rem] mb-[2rem] bg-secondary-dark border-solid border-secondary-dim border-[1px] rounded-[8px]'>
