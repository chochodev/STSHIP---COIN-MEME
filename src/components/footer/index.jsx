  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 justify-center gap-x-[5%] gap-y-[3rem] w-full px-[10%] sm:px-[1rem] md:px-[2.5rem] xl:px-[3.75rem] py-[1rem]'>
      ...
      <div className="flex flex-col gap-[.5rem]">
        ...
        <div className="flex flex-col gap-[.5rem]">
          <a href="#updates" className='text-[1.15rem] font-[600] text-primary hover:text-tertiary active:text-secondary transition-all duration-200 ease-in-out'>Updates</a>
          <a href="#home" className='text-[1.15rem] font-[600] text-primary hover:text-tertiary active:text-secondary transition-all duration-200 ease-in-out'>Follow Us</a>
          <a href="#partnership" className='text-[1.15rem] font-[600] text-primary hover:text-tertiary active:text-secondary transition-all duration-200 ease-in-out'>Partnership</a>
        </div>
      </div>
      <div className="flex flex-col gap-[.5rem]">
