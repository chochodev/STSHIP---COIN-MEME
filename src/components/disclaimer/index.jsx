...
const Disclaimer = () => {
  ...
  return (
    <div className={`${isModalOpen? 'transform translate-y-0 delay-500 opacity-1 z-[200]' : 'transform translate-y-[3rem] opacity-0 z-[-5]'} fixed top-0 left-0 flex flex-col justify-start w-full h-full bg-[#ffffff]/40 overflow-auto transition duration-200 ease-in-out`}>
      ...
      <p className="text-[.875rem] md:text-[1rem] lg:text-[1.25rem] text-secondary-light bg-background p-[2rem] px-[5%] rounded-tr-[2rem] rounded-tl-[2rem]">
      ...
      <button className='w-full flex-1 h-[5rem] flex justify-end p-[2rem] bg-background' onClick={handleCloseModal}>
